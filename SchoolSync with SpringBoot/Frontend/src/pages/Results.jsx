...
//               maxMarks: parseFloat(result.maxMarks) || 100,
...
//         !row.studentId || !row.subject || isNaN(row.marks)
//       )

//       if (invalidRows.length > 0) {
//         setMessage({
//           type: 'warning',
//           text: `Please fix invalid rows: ${invalidRows.map(r => r.row).join(', ')}`
//         })
//         setLoading(false)
//         return
//       }
